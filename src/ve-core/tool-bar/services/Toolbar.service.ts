...
import {default_dynamic_buttons, default_toolbar_buttons} from "../tool-bar-button.config";
...
export class ToolbarService {
  ...
  initApi(id: string, init: toolbarInitFn, ctrl: { $uiRouterGlobals: UIRouterGlobals} & angular.IComponentController) {
    if (!id) {
   ...
   */
  public getToolbarButton = (button: string, generic?: boolean): IToolBarButton => {
