...
const ContextBarComponent: VeComponentOptions = {
    ...
    <div class="btn-group ve-dark-dropdown-nav pull-left" uib-dropdown keyboard-nav ng-if="$ctrl.projects">
        ...
        <div class="dropdown-menu list-with-selected-item" uib-dropdown-menu role="menu">
            <a ng-repeat="project in $ctrl.projects | orderBy: 'name'" ng-click="$ctrl.updateProject(project)"
    ...
    <div ng-hide="$ctrl.spin || $ctrl.isRefsView" class="breadcrumbs">
        <div>
            <li >
                <a type="button"
                        ng-style="{{ $ctrl.truncateStyle }}"
                        class="back-to-proj" 
                        ng-click="$ctrl.goHome()" 
                        uib-tooltip="{{ $ctrl.currentProject }}" 
    ...
    <div ng-if="$ctrl.refs && !$ctrl.isRefsView" class="nav navbar-nav navbar-right" style="padding-right: 15px">
        <div class="btn-group ve-dark-dropdown-nav" uib-dropdown keyboard-nav auto-close="outsideClick">
            ...
            <div class="dropdown-menu pull-right list-with-selected-item list-with-button list-with-tabs" uib-dropdown-menu role="menu"
