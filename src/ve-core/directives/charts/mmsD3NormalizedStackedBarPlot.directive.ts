...
veCore.directive('mmsD3NormalizedStackedBarPlot', ['PlotService','$window', mmsD3NormalizedStackedBarPlot]);
 ...
 scope.render = function() {
      PlotService.readValues2(scope.plot, projectId, refId, commitId)
       .then( function(value){
