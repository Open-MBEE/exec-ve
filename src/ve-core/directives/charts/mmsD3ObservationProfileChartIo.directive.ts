...
/*
veCore.directive('mmsD3ObservationProfileChartIo', ['ElementService', 'UtilsService', 'PlotService', '$compile', 'growl','$window', mmsD3ObservationProfileChartIo]);
