...
veCore.directive('mmsD3RadarPlot', ['PlotService','$window', mmsD3RadarPlot]);
     ...
     scope.render = function() {
      ...
      PlotService.readValues(scope.plot, projectId, refId, commitId)
       .then( function(value){
        ...
        var rowvalues: { axis: string, value: number }[][] = []; //[][] {{axis: p2, value: 15}, {axis: p3: value: 1}}...
        scope.tablebody.c3_data.forEach( function (row){
          var rowvalue: { axis: string, value: number}[] = [];
