...
veApp.controller('ReorderCtrl', ['$scope', 'documentOb', 'ElementService', 'ViewService', 'AppUtilsService', 'TreeService', '$state', 'growl', '$q', '_',
function($scope, documentOb, ElementService, ViewService, AppUtilsService, TreeService, $state, growl, $q, _) {
    ...
    ViewService.handleChildViews(documentOb, 'composite', undefined, documentOb._projectId,
    ...
    function navigate(reload) {
        var curBranch = treeApi.getSelectedBranch();
        if (!curBranch) {
