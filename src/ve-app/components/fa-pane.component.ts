...
import {PaneService} from "../../ve-utils/services/PaneManager.service";
...
export class FaPaneController implements angular.IComponentController {
    ...
    constructor(private $window, private $scope: angular.pane.IPaneScope, private $compile: angular.ICompileService, private $transitions: TransitionService,
...
export let FaPaneComponent: angular.ve.ComponentOptions = {
    selector: "faPane",
    require: {
        parentPane: "?^^faPane"
    },
...
veApp.component(FaPaneComponent.selector,FaPaneComponent);
