...
import {FullDocumentService, FullDocumentServiceFactory} from "../../ve-utils/services/FullDocumentService.service";
import {ShortenUrlService} from "../../ve-utils/services/ShortenUrlService.service";
...
import {TreeService, View2NodeMap} from "../../ve-utils/services/TreeService.service";
import {EventService} from "../../ve-utils/services/EventService.service";
import {Utils} from "../../ve-directives/services/Utils.service";
import {ButtonBarApi, ButtonBarService} from "../../ve-directives/services/ButtonBar.service";
    ...
    controller: class FullDocumentController implements angular.IComponentController {
        ...
        private _createViews() {
            ...
            return this.viewSvc.handleChildViews(this.documentOb, 'composite', undefined, this.projectOb.id,
                this.refOb.id, this.view2Children, this._handleSingleView)
        ...
        private _handleSingleView(view2Children, v, aggr) {
