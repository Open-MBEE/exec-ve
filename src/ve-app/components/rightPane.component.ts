...
import { ToolbarService } from 'src/ve-directives/services/Toolbar.service';
import {SpecService} from "../../ve-directives/services/Spec.service";
import {ViewReorderApi, ViewReorderService} from "../../ve-directives/services/ViewReorder.service";
...
let RightPaneComponent: angular.ve.ComponentOptions = {
    ...
    <div class="container-fluid" ng-show="$ctrl.show.reorder">
        <mms-view-reorder mms-element-id="{{$ctrl.viewOb.id}}" mms-project-id="{{$ctrl.viewOb._projectId}}"
    ...
    controller: class RightPaneController implements angular.IComponentController {
        ...
        $onInit() {
            ...
            this.subs.push(this.eventSvc.$on('element-editor-saveall', () => {
                ...
                Object.values(this.editSvc.getAll()).forEach((ve_edit: angular.mms.ElementObject) => {
                ...
                this.elementSvc.updateElements(Object.values(this.editSvc.getAll()))
                    .then((responses) => {
                        ...
                        var elementToSelect = (<angular.mms.ElementObject>Object.values(this.editSvc.getAll())[0]);
