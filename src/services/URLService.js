...
.provider('URLService', function URLServiceProvider() {
    ...
    //OpenShift Service Host url
    // var mmsUrl = 'openmbee-mms.openmbee.svc.cluster.local:5000';
    //DNS URL
    // var mmsUrl = 'mbee-mms.navair.navy.mil';
    //KONG PROXY URL
    // var mmsUrl = 'kong-api-proxy.apps.arena-workspace.navair.navy.mil/mmsapi';
    // KeyCloak SideCar URL
    // var mmsUrl = 'openmbee-mms.apps.arena-workspace.navair.navy.mil';

    // var printUrl = 'http://localhost:8080/convert';
    var printUrl = host + '://' + mmsUrl + '/convert';
...
function urlService(baseUrl, mmsUrl, printUrl) {
    ...
    var getHeaders = function() {
        var apikey = 'tbV7TjZBYGCKWz0K2r5LDSGYeT4YGWSK';
        return {
