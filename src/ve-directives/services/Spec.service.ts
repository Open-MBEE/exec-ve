...
export class SpecService implements Injectable<any> {
    ...
    private editorApi: angular.ve.IEditorApi;
    ...
    /**
     * @ngdoc function
     * @name veDirectives.directive:mmsSpec#toggleEditing
    ...
    /**
     * @ngdoc function
     * @name veDirectives.directive:mmsSpec#setEditing
     * @methodOf veDirectives.directive:mmsSpec
     *
     * @description
     * sets editing state
    ...
    /**
     * @ngdoc function
     * @name veDirectives.directive:mmsSpec#getEditing
     * @methodOf veDirectives.directive:mmsSpec
     *
     * @description
     * get editing state
    ...
    /**
     * @ngdoc function
     * @name veDirectives.directive:mmsSpec#getEdits
     * @methodOf veDirectives.directive:mmsSpec
     *
     * @description
    ...
    setEdits(edit: angular.mms.ElementObject) {
        this.edit = edit;
    }
