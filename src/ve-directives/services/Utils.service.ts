...
export class Utils {
    ...
    static injector = ['$q', '$uibModal', '$timeout', '$compile', '$window', 'growl',
    ...
    */
    public startEdit(scope, mmsViewCtrl, domElement: JQuery, template, doNotScroll) {
    ...
    */
    public saveAction(scope, domElement: JQuery, continueEdit) {
    ...
    */
     ...
     * @param {angular.mms.ElementObject} viewOrSectionOb the view or section (instance spec) object
     */
    public addPresentationElement($ctrl: angular.IComponentController, type: string, viewOrSectionOb: angular.mms.ElementObject) {
...
Utils.$inject = Utils.injector;

veDirectives.service('Utils',  Utils)
