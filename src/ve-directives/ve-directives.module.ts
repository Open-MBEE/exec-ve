 ...
 *  <pre>
    ...
    <html ng-app="exampleApp">
        ...
        <script src="veDirectives.tpls.js"></script>
        <script src="veDirectives.js"></script>
 ...
 * ### JS (app.js)
 *  <pre>
    angular.module('exampleApp', ['veUtils', 'veDirectives']);
    </pre>
 */

var veDirectives = angular.module('veDirectives', ['veUtils', 'ui.bootstrap', 'angular-growl', 'angularjs-dropdown-multiselect', 'ui.tree-filter']);

  veDirectives.config(['$sceProvider', 'growlProvider', 'uiTreeFilterSettingsProvider', function($sceProvider, growlProvider, uiTreeFilterSettingsProvider) {
