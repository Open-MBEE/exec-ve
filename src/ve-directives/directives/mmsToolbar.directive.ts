...
import {buttonOnClickFn, TButton, ToolbarService} from "../services/Toolbar.service";
import {EventService} from "../../ve-utils/services/EventService.service";

var veDirectives = angular.module('veDirectives');

let VeToolbarComponent: angular.ve.ComponentOptions = {
	selector: 'veToolbar',
	template: `
...
veDirectives.component(VeToolbarComponent.selector,VeToolbarComponent);