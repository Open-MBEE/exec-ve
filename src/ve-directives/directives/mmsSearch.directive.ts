...
veDirectives.directive('mmsSearch', ['$window', '$anchorScroll', 'CacheService', 'ElementService', 'ProjectService', 'UtilsService', 'ViewService', 'growl', '$templateCache', '$timeout', mmsSearch]);

/**
 * @ngdoc directive
 * @name veDirectives.directive:mmsSearch
 *
 * @restrict E
 *
 * @description
...
function mmsSearch($window, $anchorScroll, CacheService, ElementService, ProjectService, UtilsService, ViewService, growl, $templateCache, $timeout) {
  ...
  function mmsSearchLink(scope, element, attrs) {
    ...
    /**
     * @ngdoc function
     * @name veDirectives.directive:mmsSearch#stringQueryUpdate
     * @methodOf veDirectives.directive:mmsSearch
     *
     * @description
    ...
    /**
     * @ngdoc function
     * @name veDirectives.directive:mmsSearch#addAdvanceSearchRow
     * @methodOf veDirectives.directive:mmsSearch
     *
     * @description
    ...
    /**
     * @ngdoc function
     * @name veDirectives.directive:mmsSearch#removeRowAdvanceSearch
     * @methodOf veDirectives.directive:mmsSearch
     *
     * @description
    ...
    /**
     * @ngdoc function
     * @name veDirectives.directive:mmsSearch#search
     * @methodOf veDirectives.directive:mmsSearch
     *
     * @description
    ...
    /**
     * @ngdoc function
     * @name veDirectives.directive:mmsSearch#getProjectMountsQuery
     * @methodOf veDirectives.directive:mmsSearch
     *
     * @description
    ...
    /**
     * @ngdoc function
     * @name veDirectives.directive:mmsSearch#getAllMountsAsArray
     * @methodOf veDirectives.directive:mmsSearch
     *
     * @description
    ...
    /**
     * @ngdoc function
     * @name veDirectives.directive:mmsSearch#buildQuery
     * @methodOf veDirectives.directive:mmsSearch
     *
     * @description
    ...
    var buildQuery = function (query) {
      ...
      var filterList = [];
      filterList.push(projectTermsOb);
