...
veDirectives.directive('mmsHistory', ['Utils','ElementService', 'ProjectService', '$templateCache', '$q', '$animate', '$uibModal', mmsHistory]);

/**
 * @ngdoc directive
 * @name veDirectives.directive:mmsHistory
 *
...
function mmsHistory(Utils, ElementService, ProjectService, $templateCache, $q, $animate, $uibModal, _) {
    ...
    var mmsHistoryLink = function(scope, element, attrs) {
        ...
        /**
         * @ngdoc function
         * @name veDirectives.directive:mmsHistory#changeElement
         * @methodOf veDirectives.directive:mmsHistory
         *
         * @description
