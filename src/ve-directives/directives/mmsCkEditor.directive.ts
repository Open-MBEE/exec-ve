...
veDirectives.directive('mmsCkeditor', ['$window', '$uibModal', '$templateCache', '$timeout', 'growl', 'CKEDITOR', 'CacheService', 'ElementService', 'UtilsService', 'ViewService', 'URLService', 'MentionService', 'Utils', mmsCkeditor]);
/**
 * @ngdoc directive
 * @name veDirectives.directive:mmsCkeditor
 * @element textarea
 *
 ...
 */
function mmsCkeditor($window, $uibModal, $templateCache, $timeout, growl, CKEDITOR, CacheService, ElementService, UtilsService, ViewService, URLService, MentionService, Utils) { //depends on angular bootstrap
    const _ = $window._;
    var generatedIds = 0;
