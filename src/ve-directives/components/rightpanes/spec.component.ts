...
import { URLService } from "src/ve-utils/services/URLService.provider";
...
import { ViewService } from "src/ve-utils/services/ViewService.service";
import { PermissionsService } from "src/ve-utils/services/PermissionsService.service";
...
/**
 * @ngdoc directive
 * @name veDirectives.directive:mmsSpec
 *
 * @requires mms.Utils
 ...
 */
let SpecComponent: angular.ve.ComponentOptions = {
    selector: 'spec',
    template: `
    <!-- HTML for edit mode -->
...
<div ng-hide="editing" class="reading">
    ...
    <div ng-hide="gettingSpec">
        ...
        <div ng-show="showDocHTML">{{$ctrl.element.documentation}}</div>
    ...
    controller: class SpecController implements angular.IComponentController {
       ...
       public addHtml(value) {
        ...
        public getTypeClass(element: angular.mms.ElementObject) {
            // Get Type
        ...
        /**
         * @ngdoc function
         * @name veDirectives.directive:mmsSpec#changeElement
         * @methodOf veDirectives.directive:mmsSpec
         *
         * @description
       ...
       public cleanupVal(obj) {
        ...
        /**
         * @ngdoc function
         * @name veDirectives.directive:mmsSpec#save
         * @methodOf veDirectives.directive:mmsSpec
         *
         * @description
         * save edited element
       ...
       public getQualifiedName() {
           ...
           if (this.edit !== undefined)
               elementOb = this.edit
           const reqOb: angular.mms.ElementsRequest = {
...
veDirectives.component(SpecComponent.selector,SpecComponent);
