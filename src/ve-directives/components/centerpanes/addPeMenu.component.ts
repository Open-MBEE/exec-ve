...
let AddPeMenuComponent: angular.ve.ComponentOptions = {
    selector: 'addPeMenu',
    template: `
...
`,
    ...
    controller: class AddPeMenuController implements angular.IComponentController {
        ...
        /**
         * @ngdoc function
         * @name veDirectives.directive:mmsView#addEltAction
...
veDirectives.component(AddPeMenuComponent.selector,AddPeMenuComponent)
