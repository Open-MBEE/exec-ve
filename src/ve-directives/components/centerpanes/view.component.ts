...
import {handleChange, onChangesCallback} from "../../../lib/changeUtils";
var veDirectives = angular.module('veDirectives');

/**
 * @ngdoc directive
 * @name veDirectives.directive:mmsView
 *
...
let ViewComponent: angular.ve.ComponentOptions = {
    ...
    <h1 ng-if="$ctrl.mmsLink" class="view-title">
      <span class="ve-view-number">{{$ctrl.view._veNumber}}</span> <mms-view-link ng-class="{'docTitle-underlined': isHover}" mms-element-id="{{$ctrl.view.id}}" mms-doc-id="{{$ctrl.view.id}}"></mms-view-link>
      <mms-view-link class="open-document" ng-mouseover="hoverIn()" ng-mouseleave="hoverOut()" mms-element-id="{{$ctrl.view.id}}" mms-doc-id="{{$ctrl.view.id}}" 
    ...
    <div ng-if="$ctrl.view._contents">
        ...
        <div ng-repeat="instanceVal in $ctrl.view._contents.operand track by instanceVal.instanceId"> 
            <mms-view-presentation-elem mms-instance-val="::instanceVal"></mms-view-presentation-elem>
...
`,
    ...
    controller: class ViewController implements angular.IComponentController {
        ...
        private presentationElemCleanUpFncs = [];
        ...
        private mmsViewApi: {  init?, elementClicked, elementTranscluded };
        ...
        private reqOb: angular.mms.ElementsRequest = {elementId: '', projectId: '', refId: '', commitId: ''};
       ...
       public setPeLineVisibility($event) {
        ...
        /**
         * @ngdoc function
         * @name veDirectives.directive:mmsView#toggleShowElements
         * @methodOf veDirectives.directive:mmsView
         *
         * @description
       ...
       public toggleShowElements() {
        ...
        /**
         * @ngdoc function
         * @name veDirectives.directive:mmsView#toggleShowComments
         * @methodOf veDirectives.directive:mmsView
         *
         * @description
       ...
       public toggleShowComments(value?: boolean) {
        ...
        /**
         * @ngdoc function
         * @name veDirectives.directive:mmsView#toggleShowEdits
         * @methodOf veDirectives.directive:mmsView
         *
         * @description
...
veDirectives.component(ViewComponent.selector,ViewComponent)