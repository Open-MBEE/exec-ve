...
import {ButtonBarApi, ButtonBarService} from "../../services/ButtonBar.service";
var veDirectives = angular.module('veDirectives');

//veDirectives.directive('buttonBar', ['$templateCache', mmsButtonBar]);

let ButtonBarComponent: angular.ve.ComponentOptions = {
    selector: "buttonBar",
    template: `
...
veDirectives.component(ButtonBarComponent.selector, ButtonBarComponent);