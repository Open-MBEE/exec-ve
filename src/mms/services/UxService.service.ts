...
export class UxService {
  ...
  getButtonBarButton(button : string, scope?) {
    switch (button) {
      case "tree-expand":
        return {id: button, icon: 'fa-caret-square-o-down', selected: true, active: true, permission: true, tooltip: 'Expand All', 
                spinner: false, togglable: false, placement: 'bottom-left', action: () => {this.eventSvc.$broadcast(button);}};
      case "tree-collapse":
      ...
      case "tree-filter":
        return {id: button, icon: 'fa-filter', selected: true, active: true, permission: true, tooltip: 'Filter', 
                spinner: false, togglable: true, action: () => {this.eventSvc.$broadcast(button);}};
      ...
      case "tree-full-document":
        return {id: button, icon: 'fa-file-text-o', selected: true, active: true, permission: true, tooltip: 'Full Document', 
                spinner: false, togglable: true, toggle_icon: 'fa-file-text', toggle_tooltip: 'View Mode', action: () => {this.eventSvc.$broadcast(button);}};
