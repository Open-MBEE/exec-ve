...
export class ElementService {
     ...
     *      same objects
     */
    getElements(reqOb, weight, update?): angular.IPromise<Array<ElementObject>> {
        var deferred: angular.IDeferred<Array<ElementObject>> = this.$q.defer();
        var request = {elements: []};
        var existing: Array<ElementObject> = [];
        this.utilsSvc.normalize(reqOb);
     ...
     *      create is successful.
     */
    createElements(reqOb): angular.IPromise<Array<ElementObject>> {
        this.utilsSvc.normalize(reqOb);
        var deferred: angular.IDeferred<Array<ElementObject>> = this.$q.defer();
        var url = this.uRLSvc.getPostElementsURL(reqOb);
     ...
     */
    isCacheOutdated(reqOb) : angular.IPromise<{status?: true, server?: ElementObject, cache?: ElementObject}> {//TODO
        var deferred = this.$q.defer();
    ...
    public getElementKey(reqOb: ElementObject, id?: undefined, edit?: boolean) {
    ...
    // {
    // "params": {
    //     "id": "_18_5_2_71301a1_1505839292792_109042_12021"
    // },
    // "recurse": {
    //     "ownerId": "id"
    // }
    //}
    public getElementQualifiedName(reqOb: ElementObject) {
        let queryOb = {
            params: {
                id: reqOb.elementId
            },
        ...
        this.search(reqOb, queryOb).then((response: angular.mms.ElementsResponse) => {
                let qualifiedName = ""
