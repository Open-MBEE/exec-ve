...
class DocgenController {
    ...
    constructor(
        ...
        private docgenSvc: DocgenService,
    ...
    $onInit() {
        ...
        this.elementSvc.getElement(reqOb).then((result) => {
            this.docgenSvc
                .viewPointMethod([result], reqOb, [
                    this.docgenSvc.collectOwnedElements(true),
                    this.docgenSvc.filterByStereotypes(
                        this.schemaSvc.getSchema<string[]>('REQUIREMENT_SID', this.schema),
                        false
                    ),
...
veViewer.component(DocgenComponent.selector, DocgenComponent);
