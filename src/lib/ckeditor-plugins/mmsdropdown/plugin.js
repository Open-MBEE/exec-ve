CKEDITOR.plugins.add('mmsdropdown',
    {
        ...
        init: function (editor) {
            ...
            editor.ui.addRichCombo('mmsExtraFeature', {
                ...
                init: function () {
                    this.add('mmscf', createItem({ isMmsCustomPlugin: true, imgSrc: window.CKEDITOR_BASEPATH + "plugins/mmscf/icons/mmscf.png", label: 'Cross Reference' }), 'Insert Cross Reference');
                    this.add('mmsvlink', createItem({ isMmsCustomPlugin: true, imgSrc: window.CKEDITOR_BASEPATH + "plugins/mmsvlink/icons/mmsvlink.png", label: 'Cross Reference as link' }), 'Insert Cross Reference as link (View Link)');
                    this.add('', '<hr>', 'mms-br');
                    ...
                    this.add('mmscomment', createItem({ isMmsCustomPlugin: true, imgSrc: window.CKEDITOR_BASEPATH + "plugins/mmscomment/icons/mmscomment.png", label: 'Comment' }), 'Insert comment');
                    this.add('', '<hr>', 'mms-br');
                    ...
                    this.add('mmssignature', createItem({ isMmsCustomPlugin: true, imgSrc: window.CKEDITOR_BASEPATH + "plugins/mmssignature/icons/mmssignature.png", label: 'Signature template' }), 'Insert signature template');
                },
