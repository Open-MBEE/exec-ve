...
export class ProjectService {
    ...
    public getOrg(orgId: string): VePromise<OrgObject, OrgsResponse> {
        ...
        if (!this.inProgress.hasOwnProperty(urlkey)) {
            this.inProgress[urlkey] = new this.$q<OrgObject, OrgsResponse>((resolve, reject) => {
        ...
        return this.inProgress[urlkey] as VePromise<OrgObject, OrgsResponse>
    }
    ...
    public getOrgs(updateCache?: boolean): VePromise<OrgObject[], OrgsResponse> {
        ...
        if (!this.inProgress.hasOwnProperty(key)) {
            this.inProgress[key] = new this.$q<OrgObject[], OrgsResponse>((resolve, reject) => {
    ...
    public getProjects(orgId?: string, updateCache?: boolean): VePromise<ProjectObject[], ProjectsResponse> {
        ...
        if (!this.inProgress.hasOwnProperty(url)) {
            this.inProgress[url] = new this.$q<ProjectObject[], ProjectsResponse>((resolve, reject) => {
    ...
    public getProject(projectId: string, updateCache?: string): VePromise<ProjectObject, ProjectsResponse> {
        ...
        if (!this.inProgress.hasOwnProperty(url)) {
            this.inProgress[url] = new this.$q<ProjectObject, ProjectsResponse>((resolve, reject) => {
                ...
                if (cached && !updateCache) resolve(this.cacheSvc.get<ProjectObject>(cacheKey))
                else {
                    this.$http
                        .get<ProjectsResponse>(url)
                        .then(
    ...
    public getProjectMounts(
        ...
        if (!this.inProgress.hasOwnProperty(url)) {
            this.inProgress[url] = new this.$q<MountObject, ProjectsResponse>((resolve, reject) => {
    ...
    public getRefs(projectId: string): VePromise<RefObject[], RefsResponse> {
        ...
        if (!this.inProgress.hasOwnProperty(url)) {
            this.inProgress[url] = new this.$q<RefObject[], RefsResponse>((resolve, reject) => {
    ...
    public getCommits(
        ...
        if (!this.inProgress.hasOwnProperty(url)) {
            this.inProgress[url] = new this.$q<CommitObject[], CommitResponse>((resolve, reject) => {
                this.$http
    ...
    public getGroups(
        ...
        if (this.inProgress.hasOwnProperty(url)) {
            this.inProgress[url] = new this.$q<GroupObject[], GroupsResponse>((resolve, reject) => {
                if (this.cacheSvc.exists(cacheKey) && !updateCache) {
