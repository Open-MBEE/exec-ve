...
import {RootScopeService} from "./RootScopeService.service";
...
export interface TreeBranch {
    label: string
    type: string
    data: angular.mms.ElementObject
    children: any[]
    level?: number
    loading?: boolean
    aggr?: string
...
export class TreeApi {
   ...
   getSiblings(branch: TreeBranch): TreeBranch[] {
     ...
     */
   getBranch(data: angular.mms.ElementObject): TreeBranch {
        var branch = null;
