...
export class ElementService {
    ...
    private _bulkUpdate(elements: ElementObject[], returnChildViews?: boolean): angular.IPromise<ElementObject[]> {
        ...
        this.$http.post(this.uRLSvc.getPostElementsURL({
            ...
            .then((response: angular.IHttpResponse<ElementsResponse>) => {
                this._bulkUpdateSuccessHandler(response.data, deferred);
            }, (response) => {
    ...
    private _bulkUpdateSuccessHandler(serverResponse: ElementsResponse, deferred: angular.IDeferred<ElementObject[]>): void {
        var results: ElementObject[] = [];
    ...
    private _bulkUpdateFailHandler(response: ElementsResponse, deferred: angular.IDeferred<ElementObject[]>, elementObs: ElementObject[]) {
