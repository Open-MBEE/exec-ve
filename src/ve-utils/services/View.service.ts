...
export class ViewService {
    ...
    public createView(
        ...
        var view = new Class({
            ...
            _appliedStereotypeIds: [
                viewOb.isDoc
                    ? this.utilsSvc.DOCUMENT_SID
                    : this.utilsSvc.VIEW_SID,
            ],
        ...
        if (parentView.id !== '') {
            let parentViewClass = new Class(this.elementSvc.fillInElement(parentView));
     ...
     */
    public getPresentationElementSpec(instanceSpec: ElementObject): ElementObject | undefined {
        ...
        this.elementSvc.getElement(req, weight).then(
            (instanceSpecification) => {
                ...
                if (
                    ...
                    this.opaqueClassifiers.indexOf(
                ...
                var presentationElement = this.getPresentationElementSpec(
                    instanceSpecification
                )
                ...
                if (this.isSection(presentationElement)) {
                    this.getElementReferenceTree(
                        req,
                        presentationElement.specification
                    ).then(
    ...
    public isSection(instanceSpec: ElementObject): boolean {
        return (
            ...
            (instanceSpec.classifierIds[0] ===
                this.TYPE_TO_CLASSIFIER_ID.Section ||
                instanceSpec.classifierIds[0] ===
                    this.TYPE_TO_CLASSIFIER_ID.SectionT)
        )
    }
    ...
    public isTable(instanceSpec: ElementObject): boolean {
        return (
            ...
            (instanceSpec.classifierIds[0] ===
                this.TYPE_TO_CLASSIFIER_ID.Table ||
                instanceSpec.classifierIds[0] ===
                    this.TYPE_TO_CLASSIFIER_ID.TableT)
        )
    }
    ...
    public isFigure(instanceSpec: ElementObject): boolean {
        return (
            ...
            instanceSpec.classifierIds.length > 0 &&
            (instanceSpec.classifierIds[0] ===
                this.TYPE_TO_CLASSIFIER_ID.ImageT ||
                instanceSpec.classifierIds[0] ===
                    this.TYPE_TO_CLASSIFIER_ID.Image ||
                instanceSpec.classifierIds[0] ===
                    this.TYPE_TO_CLASSIFIER_ID.Figure ||
                instanceSpec.classifierIds[0] ===
                    this.TYPE_TO_CLASSIFIER_ID.FigureT)
        )
    }
    ...
    public isEquation(instanceSpec: ElementObject): boolean {
        return (
            ...
            instanceSpec.classifierIds.length > 0 &&
            instanceSpec.classifierIds[0] ===
                this.TYPE_TO_CLASSIFIER_ID.Equation
        )
    }
            ...
            .then(
                (data) => {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var result: any[] = []
                        if (
                            feature === this.DOCUMENT_IDS.HEADER
                        ) {
                            //header
                            ...
                            feature == this.DOCUMENT_IDS.FOOTER
                        ) {
                            //footer
                            result = this.processSlotStrings(value)
                            ...
                            feature == this.DOCUMENT_IDS.NUM_DEPTH
                        ) {
                            //depth
                            ...
                            feature == this.DOCUMENT_IDS.NUM_SEP
                        ) {
                            //separator
                            result = this.processSlotStrings(value)
    ...
    public isGroup(instanceSpec) {
        return (
            ...
            instanceSpec._appliedStereotypeIds[0] === this.GROUP_ST_ID
        )
    }
