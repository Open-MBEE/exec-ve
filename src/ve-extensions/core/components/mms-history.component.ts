...
import {CommitObject, ElementObject, ElementsRequest, RefObject} from "@ve-utils/types/mms";
import {VeComponentOptions} from "@ve-types/view-editor";
import {handleChange} from "@ve-utils/utils";

/**
 * @ngdoc component
 * @name veExt.component:MmsHistory
 *
...
class MmsHistoryController implements angular.IComponentController {
    ...
    static $inject = ['$element', 'ElementService', 'ProjectService', 'ExtUtilService'];

    constructor(private $element: JQuery<HTMLElement>, private elementSvc: ElementService,
                private projectSvc: ProjectService, private extUtilSvc: ExtUtilService) {
    }
    ...
    /**
     * @ngdoc function
     * @name veExt.component:MmsHistory#initCallback
     * @methodOf veExt.component:MmsHistory
     *
     * @description
    ...
    revert = () => {
        this.extUtilSvc.revertAction(this, this.$element);
    };
...
veExt.component(MmsHistoryComponent.selector, MmsHistoryComponent)
