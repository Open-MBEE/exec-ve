...
veExt.directive('mmsTranscludeCom', ['ExtUtilService', 'ElementService', 'UtilsService', 'ViewService', 'ButtonBarService', 'EventService', 'MathJaxService', '$templateCache', '$compile', 'growl', mmsTranscludeCom]);
 ...
 * @requires veExt/ButtonBarService
 ...
 */
function mmsTranscludeCom(Utils, ElementService, UtilsService, ViewService, ButtonBarService, EventService, MathJaxService, $templateCache, $compile, growl) {
