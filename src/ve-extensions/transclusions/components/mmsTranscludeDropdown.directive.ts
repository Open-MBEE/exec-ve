...
For Example You could have a dropdown which includes all the people in the project and allows you to specify who is the
...
import {veExt, ExtUtilService, ExtensionService, ExtensionController} from '@ve-ext'
