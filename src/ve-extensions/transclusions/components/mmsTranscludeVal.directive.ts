...
veExt.directive('mmsTranscludeVal', ['ElementService', 'UtilsService', 'ButtonBarService', 'ExtUtilService', 'URLService', 'AuthService',
 ...
 */
function mmsTranscludeVal(ElementService, UtilsService, ButtonBarService, Utils, URLService, AuthService, $http,
