...
veDirectives.directive('mmsTranscludeName', ['ElementService', 'UxService', '$compile', 'growl', '$templateCache', 'Utils', 'ViewService', 'EventService', mmsTranscludeName]);

/**
 * @ngdoc directive
 * @name veDirectives.directive:mmsTranscludeName
 *
...
function mmsTranscludeName(ElementService, UxService, $compile, growl, $templateCache, Utils, ViewService, EventService) {
    ...
    var mmsTranscludeNameLink = function(scope, domElement: JQuery, attrs, controllers) {
