...
veDirectives.directive('mmsTranscludeDoc', ['Utils','ElementService', 'UtilsService', 'ViewService', 'UxService', 'AuthService',
    'EventService', 'MathJaxService', '$compile', '$templateCache', 'growl', mmsTranscludeDoc]);

/**
 * @ngdoc directive
 * @name veDirectives.directive:mmsTranscludeDoc
 *
 ...
 */
function mmsTranscludeDoc(Utils, ElementService, UtilsService, ViewService, UxService, AuthService, EventService, MathJaxService, $compile, growl) {
    ...
    var mmsTranscludeDocLink = function(scope, domElement : JQuery, attrs, controllers) {
