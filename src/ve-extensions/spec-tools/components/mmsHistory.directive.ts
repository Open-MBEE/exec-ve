...
veExt.directive('mmsHistory', ['ExtUtilService','ElementService', 'ProjectService', '$templateCache', '$q', '$animate', '$uibModal', mmsHistory]);

/**
 * @ngdoc directive
 * @name veExt.directive:mmsHistory
 *
...
function mmsHistory(Utils, ElementService, ProjectService, $templateCache, $q, $animate, $uibModal, _) {
    ...
    var mmsHistoryLink = function(scope, element, attrs) {
        ...
        /**
         * @ngdoc function
         * @name veExt.directive:mmsHistory#changeElement
         * @methodOf veExt.directive:mmsHistory
         *
         * @description
