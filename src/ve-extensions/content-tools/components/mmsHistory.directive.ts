...
veCore.directive('mmsHistory', ['TransclusionService','ElementService', 'ProjectService', '$templateCache', '$q', '$animate', '$uibModal', mmsHistory]);

/**
 * @ngdoc directive
 * @name veCore.directive:mmsHistory
 *
...
function mmsHistory(Utils, ElementService, ProjectService, $templateCache, $q, $animate, $uibModal, _) {
    ...
    var mmsHistoryLink = function(scope, element, attrs) {
        ...
        /**
         * @ngdoc function
         * @name veCore.directive:mmsHistory#changeElement
         * @methodOf veCore.directive:mmsHistory
         *
         * @description
