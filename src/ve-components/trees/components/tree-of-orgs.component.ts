...
export class TreeOfOrgsController extends TreeController {
    constructor(
        $q: VeQService,
        ...
        this.types = ['org', 'project'];
        this.id = 'tree-of-orgs';
    }
}

const TreeOfOrgsComponent: VeComponentOptions = {
    selector: 'treeOfOrgs',
    transclude: true,
    template: `
...
`,
    ...
    controller: TreeOfOrgsController,
};

veComponents.component(TreeOfOrgsComponent.selector, TreeOfOrgsComponent);
