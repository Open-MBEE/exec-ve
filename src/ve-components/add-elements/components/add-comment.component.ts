...
class AddCommentController extends AddElement<AddElementData> {
...
const AddCommentComponent: VeComponentOptions = {
    selector: 'addComment',
    template: `
...
veComponents.component(AddCommentComponent.selector, AddCommentComponent)
