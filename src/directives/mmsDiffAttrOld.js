...
.directive('mmsDiffAttrOld', ['ElementService', 'ConfigService', 'URLService','$q', mmsDiffAttrOld]);

/**
 * @ngdoc directive
 * @name mms.directives.directive:mmsDiffAttrOld
 *
 ...
 * ## Example
 * 
 * <mms-diff-attr-old mms-eid="element-id" mms-attr="name/doc/val" mms-version-one="timestamp/latest/tag?" mms-version-two="timestamp/latest/tag?"></mms-diff-attr-old>
 *
 ...
 */
function mmsDiffAttrOld(ElementService, ConfigService, URLService, $q) {

    var mmsDiffAttrOldLink = function(scope, element, attrs, mmsViewCtrl) {
