...
.directive('mmsSpec', ['Utils', 'AuthService', 'ElementService', 'UtilsService', '$templateCache', 'growl', '_', mmsSpec]);
 ...
 */
function mmsSpec(Utils, AuthService, ElementService, UtilsService, $templateCache, growl, _) {
