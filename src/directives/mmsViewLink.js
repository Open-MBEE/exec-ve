...
function mmsViewLink(ElementService, UtilsService, $compile, growl, ViewService, ApplicationService) {
    ...
    return {
        ...
        '<a class="external-link" target=_blank ng-href="{{href}}" ng-if="mmsExternalLink"><i class="fa fa-external-link" aria-hidden="true" title="Open document in new tab"></i></a></span>',
