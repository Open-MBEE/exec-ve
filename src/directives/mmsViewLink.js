...
.directive('mmsViewLink', ['ElementService', 'UtilsService', 'ApplicationService', '$compile', 'growl', mmsViewLink]);
 ...
 */
function mmsViewLink(ElementService, UtilsService, ApplicationService, $compile, growl) {
