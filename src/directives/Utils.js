...
.factory('Utils', ['$q','$uibModal','$timeout', '$templateCache','$rootScope','$compile', '$window', '$location', 'CacheService', 'ElementService','ViewService','UtilsService','AuthService', 'growl', '_',Utils]);
 ...
 *
 */
function Utils($q, $uibModal, $timeout, $templateCache, $rootScope, $compile, $window, $location, CacheService, ElementService, ViewService, UtilsService, AuthService, growl, _) {
    ...
    */
    ...
    var fixImgSrc = function(imgDom) {
        ...
        imgDom.attr('src', $location.protocol() + '://' + $location.host() + src + '?alf_ticket=' + AuthService.getTicket());
    };
