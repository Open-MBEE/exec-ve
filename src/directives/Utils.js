...
.factory('Utils', ['$q','$modal','$templateCache','$scope','WorkspaceService','ConfigService','ElementService', Utils]);
 ...
 * 
 */
function Utils($q,$modal,$templateCache,$scope,WorkspaceService,ConfigService,ElementService) {
     ...
     */
    var save = function(edit, mmsWs, mmsType, mmsEid, latest) {
            ...
            if (reason.status === 409) {
                ...
                instance.result.then(function(choice) {
                    if (choice === 'ok') {
                        ...
                        edit.read = latest.read;
                        edit.modified = latest.modified;
