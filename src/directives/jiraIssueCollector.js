...
function jiraIssueCollector($templateCache, $compile) {
    var jiraIssueCollectorLink = function(scope, element, attrs) {
        ...
        jQuery.ajax({
            url: "https://ehm.jpl.nasa.gov/jira/s/d41d8cd98f00b204e9800998ecf8427e/en_US-1rh5yq-1988229788/6163/44/1.4.3/_/download/batch/com.atlassian.jira.collector.plugin.jira-issue-collector-plugin:issuecollector-embededjs/com.atlassian.jira.collector.plugin.jira-issue-collector-plugin:issuecollector-embededjs.js?collectorId=ae47081",
            type: "get",
            cache: false,
            dataType: "script"
        });*/
    ...
    return {
        restrict: 'E',
        //template: '<button class="ae47081">bam</button>',
