...
describe('VizService', function () {
    ...
    beforeEach(inject(function ($injector) {
        ...
        $httpBackend
            .whenGET(
                '/alfresco/service/workspaces/master/artifacts/artifactId2'
            )
            .respond(function (method, url, data) {
                if (forceEmpty) {
                    return [200, { artifacts: [] }]
        ...
        $httpBackend
            .whenGET(
                '/alfresco/service/workspaces/master/artifacts/artifactId3'
            )
            .respond(function (method, url, data) {
                if (forceEmpty) {
                    return [200, { artifacts: [] }]
        ...
        $httpBackend
            .whenGET(
                '/alfresco/service/workspaces/master/artifacts/artifactId4?timestamp=01-01-2014'
            )
            .respond(function (method, url, data) {
                if (forceFail) {
                    return [500, 'Internal Server Error']
        ...
        $httpBackend
            .whenGET(
                '/alfresco/service/workspaces/master/artifacts/artifactId5?timestamp=01-01-2014'
            )
            .respond(function (method, url, data) {
                if (forceEmpty) {
                    return [200, { artifacts: [] }]
        ...
        $httpBackend
            .whenGET(
                '/alfresco/service/workspaces/master/artifacts/artifactId6?timestamp=01-01-2014'
            )
            .respond(function (method, url, data) {
                if (forceEmpty) {
                    return [200, { artifacts: [] }]
        ...
        $httpBackend
            .whenGET(
                '/alfresco/service/workspaces/master/artifacts/artifactId7/versions/version1'
            )
            .respond(function (method, url, data) {
                if (forceFail) {
                    return [500, 'Internal Server Error']
    ...
    it('getImageURL', inject(function () {
        ...
        VizService.getImageURL('artifactId3', true, undefined, 'latest').then(
            function (response) {
                expect(response).toEqual('/alfresco/image/url/path/image.jpg')
            }
        )
