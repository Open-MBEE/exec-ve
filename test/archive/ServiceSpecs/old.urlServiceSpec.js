...
describe('URLService', function () {
    ...
    it('getConfigSnapshotsURL', inject(function () {
        expectedReturn =
            root +
            '/workspaces/master/sites/ems/configurations/configId/snapshots'
        expect(
            URLService.getConfigSnapshotsURL('configId', 'ems', 'master')
        ).toEqual(expectedReturn)
    }))

    it('getProductSnapshotsURL', inject(function () {
        expectedReturn =
            root + '/workspaces/master/sites/ems/products/productId/snapshots'
        expect(
            URLService.getProductSnapshotsURL('productId', 'ems', 'master')
        ).toEqual(expectedReturn)
    }))

    it('getSiteConfigsURL', inject(function () {
        expectedReturn = root + '/workspaces/master/sites/ems/configurations'
        expect(URLService.getSiteConfigsURL('ems', 'master')).toEqual(
            expectedReturn
        )
    }))
    ...
    it('getConfigProductsURL', inject(function () {
        expectedReturn =
            root +
            '/workspaces/master/sites/ems/configurations/configId/products'
        expect(
            URLService.getConfigProductsURL('configId', 'ems', 'master')
        ).toEqual(expectedReturn)
    }))

    it('getConfigURL', inject(function () {
        expectedReturn =
            root + '/workspaces/master/sites/ems/configurations/configId'
        expect(URLService.getConfigURL('configId', 'ems', 'master')).toEqual(
            expectedReturn
        )
    }))
    ...
    it('getSiteProductsURL', inject(function () {
        ...
        expect(URLService.getSiteProductsURL('ems', 'master')).toEqual(
            expectedReturn
        )
    }))
    ...
    it('getImageURL', inject(function () {
        ...
        // latest
        expect(
            URLService.getImageURL('artifactId', 'master', 'latest')
        ).toEqual(expectedReturn)

        // timestamp
        expectedReturn += '?timestamp=01-01-2014'
        expect(
            URLService.getImageURL('artifactId', 'master', '01-01-2014')
        ).toEqual(expectedReturn)

        // version
        expectedReturn =
            root + '/workspaces/master/artifacts/artifactId/versions/versionId'
        expect(
            URLService.getImageURL('artifactId', 'master', 'versionId')
        ).toEqual(expectedReturn)
    }))
    ...
    it('getElementURL', inject(function () {
        ...
        // latest
        expect(URLService.getElementURL('elementId', 'master', 'latest')).toBe(
            expectedReturn
        )
        ...
        expectedReturn += '?timestamp=01-01-2014'
        expect(
            URLService.getElementURL('elementId', 'master', '01-01-2014')
        ).toBe(expectedReturn)

        // version
        expectedReturn =
            root + '/workspaces/master/elements/elementId/versions/versionId'
        expect(
            URLService.getElementURL('elementId', 'master', 'versionId')
        ).toBe(expectedReturn)
    }))
    ...
    it('getViewDatasURL', inject(function () {
        ...
        // latest
        expect(
            URLService.getViewDatasURL('viewId', 'master', 'latest')
        ).toEqual(expectedReturn)

        // timestamp
        expectedReturn += '?timestamp=01-01-2014'
        expect(
            URLService.getViewDatasURL('viewId', 'master', '01-01-2014')
        ).toEqual(expectedReturn)

        // version
        expectedReturn =
            root + '/workspaces/master/views/viewId/versions/versionId'
        expect(
            URLService.getViewDatasURL('viewId', 'master', 'versionId')
        ).toEqual(expectedReturn)
    }))
    ...
    it('getElementVersionsURL', inject(function () {
        ...
        expect(URLService.getElementVersionsURL('elementId', 'master')).toEqual(
            expectedReturn
        )
    }))
    ...
    it('getElementSearchURL', inject(function () {
        ...
        expect(URLService.getElementSearchURL('muschek', 'master')).toBe(
            expectedReturn
        )
    }))
