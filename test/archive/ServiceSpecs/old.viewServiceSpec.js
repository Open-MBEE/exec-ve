...
describe('ViewService', function () {
    ...
    beforeEach(inject(function ($injector) {
        ...
        $httpBackend
            .whenGET(
                '/alfresco/service/workspaces/master/views/12345/elements?timestamp=01-01-2014'
            )
            .respond({
                elements: [
                    {
        ...
        $httpBackend
            .whenGET('/alfresco/service/workspaces/master/views/12345/elements')
            .respond({
                elements: [
                    {
                        author: 'muschek',
        ...
        $httpBackend
            .whenGET(
                root +
                    '/workspaces/master/sites/siteId/products/54321/views?timestamp=01-01-2014'
            )
            .respond({
                elements: [
                    {
        ...
        $httpBackend
            .whenGET(
                root + '/workspaces/master/sites/siteId/products/65432/views'
            )
            .respond({
                elements: [
                    {
        ...
        $httpBackend
            .whenGET(root + '/workspaces/master/elements/badId')
        ...
        $httpBackend
            .whenGET(root + '/workspaces/master/elements/noSpecDocId')
            .respond({
                elements: [
                    {
                        author: 'muschek',
        ...
        $httpBackend
            .whenGET(root + '/workspaces/master/elements/emptyView2ViewDocId')
            .respond({
                elements: [
                    {
                        author: 'muschek',
        ...
        $httpBackend
            .whenGET(root + '/workspaces/master/elements/noIdMatchDocId')
            .respond({
                elements: [
                    {
                        author: 'muschek',
                        ...
                        specialization: {
                            type: 'Product',
                            view2view: [
                                { id: 'notMatchingId', childrenViews: [] },
                            ],
                        },
                    },
                ],
        ...
        $httpBackend
            .whenGET(root + '/workspaces/master/elements/idMatchDocId')
            .respond({
                elements: [
                    {
        ...
        $httpBackend
            .when('POST', root + '/workspaces/master/elements')
        ...
        $httpBackend
            .whenGET(root + '/workspaces/master/sites/ems/products')
            .respond(function (method, url, data) {
                if (forceFail) {
    ...
    it('getViewDatas', inject(function () {
        ...
        ViewService.getViewDatas('12345', false, 'master', '01-01-2014').then(
            function (response) {
        ...
        ViewService.getViewDatas('12345', false, 'master', 'latest').then(
            function (response) {
                expect(response.length).toEqual(2)
                expect(response[0]).toEqual({
                    author: 'muschek',
        ...
        ViewService.getViewDatas('12345', true, 'master', 'latest').then(
            function (response) {
                expect(response.length).toEqual(2)
                expect(response[0]).toEqual({
                    author: 'muschek',
    ...
    it('createView', inject(function () {
        ...
        ViewService.createView('ownerId', undefined, undefined, 'master').then(
            function (response) {
                ...
                expect(response.specialization.allowedElements).toEqual([
                    response.sysmlid,
                ])
                expect(response.specialization.displayedElements).toEqual([
                    response.sysmlid,
                ])
    ...
    it('getSiteDocuments', inject(function () {
        ...
        ViewService.getSiteDocuments('ems', false, undefined).then(function (
            response
        ) {
            expect(response.length).toEqual(1)
