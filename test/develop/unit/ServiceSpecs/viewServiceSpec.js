...
xdescribe('Service: ViewService', function () {
    ...
    describe('Method: downgradeDocument', function () {
        it('it should demote an object to a view', function () {
            ...
            newElemOb._appliedStereotypeIds = [
                '_11_5EAPbeta_be00301_1147420760998_43940_227',
            ]
            $httpBackend
                .when('POST', root + '/elements/heyanelement', newElemOb)
    ...
    describe('Method: getViewDatas', function () {
        it('it should get the element objects for elements allowed in the view', function () {
            ...
            $httpBackend
                .when('GET', root + '/elements/heyanelement')
                .respond(function (method, url, data) {
                    return [200, testElem]
                })
    ...
    describe('Method CreateView', function () {
        ...
        it('create a view similar to the workspace state in the tree controller', inject(function () {
            ViewService.createView(
                ownerId,
                'create view for tree',
                'idMatchDocId',
                'master'
            ).then(
                function (data) {
                    expect(data.ownerId).toEqual(
                        'MMS_1442345799882_df10c451-ab83-4b99-8e40-0a8e04b38b9d'
                    )
                },
                function (reason) {
                    console.log('this happened' + reason)
    ...
    xdescribe('Method createInstanceSpecification', function () {
        it('should update View object called like controller.utils without a name', inject(function () {
            ViewService.createInstanceSpecification(
                ownerId,
                'master',
                'Paragraph'
            ).then(
    ...
    xdescribe('Method getViewDatas', function () {
        ...
        it('should return the element from the mock server', function () {
            ...
            ViewService.getViewDatas('elemId', false, 'master', 'latest').then(
                function (data) {
                    console.log(
                        'The long object ' + JSON.stringify(data, null, ' ')
                    )
                },
                function () {
                    console.log('fail')
