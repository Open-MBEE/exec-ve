...
.directive('oldveNav', ['$templateCache', '$state', 'hotkeys', 'growl', '$location', '$uibModal', 'ApplicationService','AuthService', oldveNav]);
 ...
 */
function oldveNav($templateCache, $state, hotkeys, growl, $location, $uibModal, ApplicationService, AuthService) {
