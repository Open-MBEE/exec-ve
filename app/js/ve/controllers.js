...
.controller('ReorderCtrl', ['$scope', '$rootScope', 'document', 'ElementService', 'ViewService', '$state', 'growl', 'ws',
function($scope, $rootScope, document, ElementService, ViewService, $state, growl, ws) {
    $scope.doc = document;
    $scope.ws = ws;
    var viewElementIds = [];
    var viewElementIds2TreeNodeMap = {};
